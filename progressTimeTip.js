/*
* Time Tip plugin for Azure Media Player - Microsoft Sample Code - Copyright (c) 2016 - Licensed MIT
* Attribution: videojs-progressTips v0.1.0 - https://github.com/mickey/videojs-progressTips Copyright (c) 2013 Michael Bensoussan; Licensed MIT 
*/
        ...
        init = function () {
            ...
            var timeTipUpdate = function (event) {
                ...
                if (player.isLive() && timeInSeconds > player.duration() - /*player.currentPlayerSettingValue("liveEdgePlaybackThreshold") - */player.currentPlayerSettingValue("livePlaybackOffsetInSec")) {
                    ...
                    progressTimeTipInner.innerHTML = "0:00"
                } else {
